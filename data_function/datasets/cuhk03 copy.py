...
class CUHK03(BaseDataset):
    ...
    def __init__(self, root="", split_id=0, cuhk03_labeled=True, cuhk03_classic_split=False, **kwargs):
        ...
        splits = utils.common.read_json(split_path)
    ...
    def preprocess_split(self):
        ...
        utils.common.mkdir_if_missing(self.imgs_detected_dir)
        utils.common.mkdir_if_missing(self.imgs_labeled_dir)
        ...
        utils.common.write_json(splits_classic_det, self.split_classic_det_json_path)
        utils.common.write_json(splits_classic_lab, self.split_classic_lab_json_path)
        ...
        train_info, query_info, gallery_info = _extract_new_split(loadmat(self.split_new_det_mat_path), self.imgs_detected_dir)
        split = [
            {
                "train": train_info[0],
                "query": query_info[0],
        ...
        utils.common.write_json(split, self.split_new_det_json_path)

        print("Creating new split for labeled images (767/700) ...")
        train_info, query_info, gallery_info = _extract_new_split(loadmat(self.split_new_lab_mat_path), self.imgs_labeled_dir)
        split = [
            {
                "train": train_info[0],
                "query": query_info[0],
        ...
        utils.common.write_json(split, self.split_new_lab_json_path)
