...
class ODEBlock(nn.Module):
    ...
    def forward(self, x):
        ...
        trajs = odeint(self.odefunc, coords, integration_time, method="rk4", rtol=1e-3, atol=1e-3)  # (n_trajs, bs, 2*c, h, w)
...
class ReidNet(nn.Module):
    def __init__(self, num_classes, config, logger, **kwargs):
        ...
        self.auxiliary_classifier_head2 = Auxiliary_classifier_head(2048, num_classes, config, logger)
