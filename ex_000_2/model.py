...
class ReidNet(nn.Module):
    def __init__(self, num_classes, config, logger, **kwargs):
        ...
        # Reduction
        self.reduction = nn.Conv2d(2048, 512, kernel_size=1, stride=1, bias=False)

        # Classifier head
        self.classifier_head = Classifier_head(512, num_classes, config, logger)
    ...
    def forward(self, x):
        ...
        # Reduction
        resnet_feats = self.reduction(resnet_feats)  # (bs, 512, 16, 8)
