...
class ReidNet(nn.Module):
    ...
    def forward(self, x, pids=None):
        ...
        if self.training:
            ...
            integrate_bn_feat, integrate_cls_score = self.auxiliary_classifier_head(integrate_feats)
            integrate_mse_loss = torch.norm((integrate_bn_feat - backbone_bn_feats), p=2)

            return backbone_cls_score, backbone_pool_feats, integrate_cls_score, integrate_mse_loss
        else:
