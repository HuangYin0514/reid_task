...
if __name__ == "__main__":
    ...
    if args.outputs_path != "":
        config.outputs_path = args.outputs_path
    outputs_path = config.outputs_path
    config.models_outputs_path = os.path.join(outputs_path, "models")
    config.logs_outputs_path = os.path.join(outputs_path, "logs")
    config.temps_outputs_path = os.path.join(outputs_path, "temps")
