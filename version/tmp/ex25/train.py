...
def brain(config, logger):
    ...
    for epoch in range(config.epochs):
        ...
        for ind, data in enumerate(tqdm(train_loader)):
            ...
            #### auxiliary loss
            integrat_feats_map, integrat_pids = model.integratFeatureMap(resnet_feat, pids, model.classifier_head)
            ...
            auxiliary_loss = IP_ce_loss

            #### All loss
            loss = G_loss + 0.01 * auxiliary_loss
