...
class IntegratFeatureMap(nn.Module):
    def __init__(self, config, logger):
        ...
        self.fusion_layers = nn.Sequential(conv11, bn, act)
    ...
    def forward(self, feats_map, pids, classifier):
        ...
        # feats_map_raw = torch.einsum("bc, bcij -> bij", params_selected[pids], feats_map.detach())
        ...
        feats_map_raw = self.fusion_layers(feats_map)
        localized_features_map = feats_map * feats_map_raw
