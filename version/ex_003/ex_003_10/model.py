...
class ECALayer(nn.Module):
    def __init__(self, channels, config=None, logger=None, gamma=2, b=1):
        super().__init__()
...
class Hierarchical_aggregation(nn.Module):
    def __init__(self, num_classes, config, logger, **kwargs):
        ...
        self.feats_enhance_1 = Conv_bn_relu(256, config, logger)
        self.feats_enhance_2 = Conv_bn_relu(768, config, logger)
        self.feats_enhance_3 = Conv_bn_relu(1792, config, logger)
        ...
        self.attention = ECALayer(1792, config, logger)
