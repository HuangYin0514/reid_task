...
class Hierarchical_aggregation(nn.Module):
    ...
    def forward(
        ...
        out_attention_x1 = self.attention_p1(x1) * x1
        pool_p1 = self.pool_p1(out_attention_x1)
        p1 = self.feats_enhance_1(pool_p1)

        out_attention_x2 = self.attention_p2(x2) * x2
        pool_p2 = self.pool_p2(out_attention_x2)
        p2 = self.feats_enhance_2(pool_p2)

        out_attention_x3 = self.attention_p3(x3) * x3
        pool_p3 = self.pool_p3(out_attention_x3)
