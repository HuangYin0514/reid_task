...
def brain(config, logger):
    ...
    for epoch in range(config.epochs):
        ...
        for ind, data in enumerate(tqdm(train_loader)):
            ...
            fc_1_score, fc_2_score, fc_3_score, p1, p2, p3 = model.hierarchical_aggregation(
            ...
            full_feats = torch.cat((p1, p2, p3, resnet_feats), dim=1)
            integrate_feats, integrate_pids = model.integrate_feats_module(full_feats, pids, backbone_cls_score, num_same_id=4)
