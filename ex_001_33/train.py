...
def brain(config, logger):
    ...
    for epoch in range(config.epochs):
        ...
        for ind, data in enumerate(tqdm(train_loader)):
            ...
            fc_1_ce_loss = ce_labelsmooth_loss(fc_1_score, integrate_pids)
            fc_2_ce_loss = ce_labelsmooth_loss(fc_2_score, integrate_pids)
            fc_3_ce_loss = ce_labelsmooth_loss(fc_3_score, integrate_pids)
