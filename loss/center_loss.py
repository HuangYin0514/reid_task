...
class CenterLoss(nn.Module):
    ...
    def __init__(self, num_classes, feature_dim, config, logger):
        super().__init__()
        self.num_classes = num_classes
        self.feature_dim = feature_dim
        self.use_gpu = config.device == "cuda"
    ...
    def forward(self, x, labels):
        ...
        distmat = torch.addmm(input=distmat, mat1=x, mat2=self.centers.t(), alpha=-2, beta=1)
